...
{	
    ...
    ui.sidebar.addPalette('SecurITLibrary', 'SecurIT Customized', true, function(content)
 	{	
		...
		content.appendChild(ui.sidebar.createVertexTemplate('image;image=https://raw.githubusercontent.com/CoolZeroNL/draw-io-plugins/master/securit.huisstyle.images/unicorn.svg', 100, 100));
		content.appendChild(ui.sidebar.createVertexTemplate('image;image=https://raw.githubusercontent.com/CoolZeroNL/draw-io-plugins/master/securit.huisstyle.images/sit-header.svg', 100, 100));
